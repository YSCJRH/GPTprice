...
export function AboutPage({ language }: AboutPageProps) {
    ...
    return (
      <main className="mx-auto grid w-full max-w-4xl gap-5 px-4 py-8 sm:px-6 lg:px-8">
        <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
          <h1 className="text-4xl font-semibold tracking-tight text-slate-950">About GPTprice</h1>
        </div>
        <TextBlock
  ...
  return (
    <main className="mx-auto grid w-full max-w-4xl gap-5 px-4 py-8 sm:px-6 lg:px-8">
      <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        <h1 className="text-4xl font-semibold tracking-tight text-slate-950">关于 GPTprice</h1>
      </div>
      <TextBlock
        title="项目边界"
